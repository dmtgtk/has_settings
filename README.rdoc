...
for the receiver will be checked and inheritance ignored; and the pair of methods

  get(symbol_or_name)
  set(symbol_or_name, value)

can be used instead of attribute access in situation when setting names are dynamic (e.g loading settings from YAML):

  group.settings.get('site_theme')              # same as group.settings.site_theme
  group.settings.set(:site_theme, 'ponies')     # same as group.settings.site_theme = 'ponies'
